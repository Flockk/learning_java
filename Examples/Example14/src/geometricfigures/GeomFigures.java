...
public class GeomFigures {
    public static void main(String[] args) {
        ...
        System.out.println("Perimeter rect: " + rect.getPerimeter() + ", area rect: " + rect.getArea());
        System.out.println("Perimeter circle: " + circle.getPerimeter() + ", area circle: " + circle.getArea());
        ...
        System.out.println("Perimeter square: " + square.getPerimeter() + ", area square: " + square.getArea());
    }
}
